...
(function () {
  ...
  function ensureStyle() {
    ...
    st.textContent =
      ...
      "#cupFsBtn{background:none;border:none;cursor:pointer;color:var(--text-secondary,#6b7684);padding:4px 8px;display:inline-flex;align-items:center;justify-content:center;border-radius:8px;transition:.12s;-webkit-tap-highlight-color:transparent;}" +
