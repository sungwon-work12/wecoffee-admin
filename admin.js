...
/*   상세(memCupReview)가 여는 wcOpenCupHistory 정의. 오버레이 평소 숨김 + 열 때 전체화면. */
(function(){
  "use strict";
  try{
    if(!window.supabaseClient && typeof supabase!=="undefined" && supabase.createClient){
