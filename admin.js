...
window.renderAppTable = function(data) {
    ...
    data.forEach(row=>{
        ...
        let _mTimeHtml = _mRawTime ? `<div style="font-size:12px;margin-top:4px;"><span style="color:var(--text-secondary);font-weight:700;">${_mTimeLabel}</span>&nbsp;<span style="color:var(--text-display);font-weight:600;">${window.escapeHtml(_mRawTime)}</span></div>` : '';
