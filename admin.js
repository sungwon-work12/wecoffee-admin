...
let isAppInitialized = false; // 세션 중복 실행(버퍼링) 방지 플래그
...
window.fetchHolidays = async function(year) {
  ...
  window.holidaysCache['fetched_' + year] = true; // API 병목 방지 도장
