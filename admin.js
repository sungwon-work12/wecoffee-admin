...
// 💡 타임라인 CSS를 전역으로 분리하여 디자인 깨짐 현상을 영구 차단합니다.
if (!document.getElementById('wecoffee-custom-styles')) {
    ...
    style.innerHTML = `
        ...
        /* 타임라인 레이아웃 강제 100% 및 표 디자인 뼈대 복구 CSS */
...
window.fetchCenterData = async function() {
  ...
  // 💡 타임라인 삽입 위치를 5:5 배너 컨테이너 바깥쪽 하단으로 이동시키는 로직 (안전 삽입)
  try {
...
window.renderTimeline = function() {
    ...
    // 💡 해결: 파트 1에 안전하게 적용된 글로벌 CSS에 맡기고, 충돌하는 인라인 <style> 태그를 완전히 제거합니다.
    let finalHtml = `
