...
window.renderCenterData=function(){
  ...
  const now=new Date();const oneMonthAgo=new Date(now.getFullYear(),now.getMonth(),1);oneMonthAgo.setHours(0,0,0,0);let todayForBlk=new Date();todayForBlk.setHours(0,0,0,0);
