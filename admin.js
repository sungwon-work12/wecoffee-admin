...
// 🔥 수정됨: renderCenterData 전체 변경 (필터 연동 로직 추가됨)
window.renderCenterData = function() {
  ...
  // 🔥 신청자(훈련) 리스트 렌더링 - 선택된 블록 필터(selectedBlockFilter) 반영
  try {
