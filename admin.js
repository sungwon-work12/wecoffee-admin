...
/* ═══════════════════════════════════════════════════════════
   ...
   · 관리자 내역 상세(memCupReview)가 여는 window.wcOpenCupHistory 정의.
   · 멤버 페이지 모듈 원본 그대로 + 관리자용 shim.
   의존: 파트 1~4 · 커핑 8(v8, memCupReview)
   ═══════════════════════════════════════════════════════════ */
(function(){
  "use strict";
  try{
