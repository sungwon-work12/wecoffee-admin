...
counselorChartHtml+=`<div class="wc-anim-card" style="margin-bottom:20px;animation-delay:${0.1+i*0.08}s"><div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:8px;"><span style="font-size:15px;font-weight:800;color:var(--text-display);">${window.escapeHtml(name)}</span><span style="font-size:13px;font-weight:600;color:var(--text-secondary);">${stats.joined}/${stats.total}명 <span style="color:var(--primary);font-weight:800;">(${Math.round(jp)}%)</span></span></div><div style="display:flex;height:16px;border-radius:8px;overflow:hidden;background:#f2f4f6;"><div class="wc-anim-bar" style="--target-w:${jp}%;height:100%;background:#32b06a;animation-delay:${0.4+i*0.1}s"></div><div class="wc-anim-bar" style="--target-w:${dp}%;height:100%;background:#e85d5d;animation-delay:${0.5+i*0.1}s"></div><div class="wc-anim-bar" style="--target-w:${pp}%;height:100%;background:#d1d5db;animation-delay:${0.6+i*0.1}s"></div></div><div style="display:flex;gap:14px;margin-top:8px;font-size:12px;color:var(--text-tertiary);font-weight:600;"><span><span style="display:inline-block;width:8px;height:8px;background:#32b06a;border-radius:2px;margin-right:4px;vertical-align:middle;"></span>가입 ${stats.joined}</span><span><span style="display:inline-block;width:8px;height:8px;background:#e85d5d;border-radius:2px;margin-right:4px;vertical-align:middle;"></span>이탈 ${stats.dropout}</span><span><span style="display:inline-block;width:8px;height:8px;background:#d1d5db;border-radius:2px;margin-right:4px;vertical-align:middle;"></span>진행 중 ${stats.pending}</span></div></div>`;});
